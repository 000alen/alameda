export type DefineFunction = ((dependencies: string[], factory: (...args: any[]) => any) => void) | ((name: string, dependencies: string[], factory: (...args: any[]) => any) => void) | ((name: string, factory: any) => void);
export type RequireFunction = <T extends any[] = any[]>(dependencies: string | string[] | null | undefined, callback?: (...args: T) => void, errback?: (error: Error) => void) => Promise<T>;
...
export interface Config {
    ...
    scriptType?: string;
    onNodeCreated?: (script: HTMLScriptElement, config: Config, id: string, url: string) => void;
...
export declare class AlamedaError extends Error {
    dynaId?: string;
