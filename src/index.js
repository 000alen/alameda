...
var topReq, dataMain, src, subPath, bootstrapConfig = requirejs || require, contexts = {}, queue = [], currDirRegExp = /^\.\//, urlRegExp = /^\/|\:|\?|\.js$/, commentRegExp = /\/\*[\s\S]*?\*\/|([^:"'=]|^)\/\/.*$/gm, cjsRequireRegExp = /[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g, jsSuffixRegExp = /\.js$/, slice = Array.prototype.slice;
function newContext(contextName) {
    var req, main, makeMap, callDep, handlers, checkingLater, load, context, defined = (0, utils_1.obj)(), waiting = (0, utils_1.obj)(), config = {
        ...
        shim: {},
        config: {},
    }, mapCache = (0, utils_1.obj)(), requireDeferreds = [], deferreds = (0, utils_1.obj)(), calledDefine = (0, utils_1.obj)(), calledPlugin = (0, utils_1.obj)(), loadCount = 0, startTime = new Date().getTime(), errCount = 0, trackedErrors = (0, utils_1.obj)(), urlFetched = (0, utils_1.obj)(), bundlesMap = (0, utils_1.obj)(), asyncResolve = Promise.resolve();
    /**
    ...
    function makeShimExports(value) {
        function fn() {
            ...
            return ret || (value.exports && (0, utils_1.getGlobal)(value.exports));
        }
        return fn;
    }
    ...
    function breakCycle(d, traced, processed) {
        ...
        if (!d.finished && d.deps) {
            d.deps.forEach(function (depMap) {
                var depId = depMap.id, dep = !(0, utils_1.hasProp)(handlers, depId) && getDefer(depId, depMap);
    ...
    function check(d) {
        var err, mid, dfd, notFinished = [], waitInterval = config.waitSeconds * 1000, 
    ...
    main = function (name, deps, factory, errback, relName) {
        ...
        if (typeof factory === "function") {
            if (!deps.length && factory.length) {
                ...
                factory
                    .toString()
                    .replace(commentRegExp, utils_1.commentReplace)
